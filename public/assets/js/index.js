...
function projectBtn() {
  ...
  function loadPage(page) {
    ...
    xhttp.open("GET", "pages/landing.php", true);
    xhttp.send();
  }
}
  ...
  function loadPage(page) {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState === 4) {
        ...
        var elmnt = document.getElementById("myskill");
        elmnt.scrollIntoView(false);
      }
    };
    xhttp.open("GET", "pages/landing.php", true);
  ...
  function loadPage(page) {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState === 4) {
        ...
        var elmnt = document.getElementById("mycertificate");
        elmnt.scrollIntoView(false);
      }
    };
    xhttp.open("GET", "pages/landing.php", true);
  ...
  function loadPage(page) {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState === 4) {
        ...
        var elmnt = document.getElementById("endsection");
        elmnt.scrollIntoView(false);
      }
    };
    xhttp.open("GET", "pages/landing.php", true);
...
function portofolioBtn() {
  const page = document
    .getElementById("linktoportofolio")
    .getAttribute("href")
    .substr(1);
  loadPage(page);
  console.log("testwork");
